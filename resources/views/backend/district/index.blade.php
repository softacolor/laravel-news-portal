              ...
              <table class="table table-bordered">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="{{route('edit.district', $dis->id)}}" class="btn btn-info">Edit</a>
                      <a href="{{route('delete.district', $dis->id)}}" onclick="return confirm('Are you sure to delete?')" class="btn btn-danger">Delete</a>
                    </td>
                  </tr>
