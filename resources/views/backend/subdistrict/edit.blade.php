        ...
        <div class="card-body">
          ...
          <form class="forms-sample" method="POST" action="{{ route('update.subdistrict',$subdistrict->id)}}">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="subdistrict_bn" value="{{ $subdistrict->subdistrict_bn}}">
            ...
            <div class="form-group">
                ...
                <select class="form-control" name="district_id" id="exampleFormControlSelect2">
                  ...
                  <option value="{{ $item->id}}" <?php if($item->id == $subdistrict->district_id) echo "selected"; ?>>{{ $item->district_bn}} | {{ $item->district_en}}</option>
                  @endforeach
