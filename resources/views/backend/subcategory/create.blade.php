        ...
        <div class="card-body">
          ...
          <form class="forms-sample" method="POST" action="{{ route('store.subcategory')}}">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="subcategory_bn" placeholder="Subcategory Name Bangla">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="subcategory_en" placeholder="Subcategory Name English">
            ...
            <div class="form-group">
              ...
              <select class="form-control" name="category_id" id="exampleFormControlSelect2">
                ...
                <option value="{{ $item->id}}">{{ $item->category_bn}} | {{ $item->category_en}}</option>
                @endforeach
