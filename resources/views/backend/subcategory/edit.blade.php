        ...
        <div class="card-body">
          ...
          <form class="forms-sample" method="POST" action="{{ route('update.subcategory',$subcategory->id)}}">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="subcategory_bn" value="{{ $subcategory->subcategory_bn}}">
            ...
            <div class="form-group">
                ...
                <select class="form-control" name="category_id" id="exampleFormControlSelect2">
                  ...
                  <option value="{{ $item->id}}" <?php if($item->id == $subcategory->category_id) echo "selected"; ?>>{{ $item->category_bn}} | {{ $item->category_en}}</option>
                  @endforeach
