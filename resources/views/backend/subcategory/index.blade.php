            ...
            <div class="table-responsive">
              <table class="table table-bordered">
                ...
                <tbody>
                  ...
                  <tr>
                    <td>{{$i++}}</td>
                    <td>{{$cat->subcategory_bn}}</td>
                    <td>{{$cat->subcategory_en}}</td>
                    <td>{{$cat->category_en}}</td>
                    <td>
                      <a href="{{route('edit.subcategory', $cat->id)}}" class="btn btn-info">Edit</a>
                      <a href="{{route('delete.subcategory', $cat->id)}}" onclick="return confirm('Are you sure to delete?')" class="btn btn-danger">Delete</a>
                    </td>
                  </tr>
