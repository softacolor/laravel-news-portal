...
<div class="col-12 grid-margin stretch-card">
 ...
 <div class="row">
  ...
  <?php if ($row->id == $post->category_id) {
    echo "selected"; } ?> >{{ $row->category_bn  }} </option>
                @endforeach
                        </select>
    </div>
  ...
  <?php if ($row->id == $post->subcategory_id) {
    echo "selected"; } ?> >{{ $row->subcategory_bn  }} </option>
                @endforeach
 ...
 <option value="{{ $row->id }}"
  <?php if ($row->id == $post->district_id) {
    echo "selected"; } ?> >{{ $row->district_bn  }} </option>
                @endforeach
                        </select>
    </div>
  ...
  <?php if ($row->id == $post->subdistrict_id) {
    echo "selected"; } ?> >{{ $row->subdistrict_bn  }} </option>
                @endforeach
                        </select>
    </div>
...
<div class="form-group">
   ...
   <textarea class="form-control" name="details_bn" id="summernote">
     {{ $post->details_bn }}
